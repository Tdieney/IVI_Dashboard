...
AdaptiveLayoutManager.prototype.getWidthRatio = function() {
    return (this.newWidth / this.originalWidth);
}

AdaptiveLayoutManager.prototype.getHeightRatio = function() {
    return (this.newHeight / this.originalHeight);
}
